...
git commit -m "Initial commit: Enhanced github-readme-stats with managed repos feature" -m "- Added include_managed_repos parameter for stats and top-langs APIs" -m "- Support for ADMIN and MAINTAIN permission filtering" -m "- Enhanced GraphQL queries with viewerPermission field" -m "- Updated documentation with new feature examples" -m "- Maintained backward compatibility with original features"
